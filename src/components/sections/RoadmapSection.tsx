const RodmapBox = () => {
    return (
        <div className="w-[500px] h-[400px] rounded-[15px] hover:p-[5px] bg-gradient1 hover:border-0 border-2 border-[#1A1A1A]">
...
const RoadmapSection = () => {
    return (
        <section className="section flex-col gap-[90px]">
            <div className="ml-[193px] w-full">
                <p className="font-bold font-title text-[100px] leading-[115px] text-white">{'// VENDMAP'}</p>
